...
L10n::$locales['You are an admin, you must change password from backend.'] = 'Vous êtes administrateur, vous devez changer votre mot de passe depuis l\'interface d\'administration.';
L10n::$locales['The e-mail was sent successfully to %s.'] = 'Le message a été envoyé à %s.';
L10n::$locales['You must set a new password.'] = 'Vous devez changer votre mot de passe.';
L10n::$locales['Unable to retrieve user informations.'] = 'Impossible de retrouver les informations de l\'utilisateur.';
...
L10n::$locales['Confirmation of activation'] = 'Confirmation d\'activation';
L10n::$locales['Thank you for your registration on blog "$s"!'] = 'Merci pour votre inscription sur le blog "%s" !';
L10n::$locales['Your account is now activated.'] = 'Votre compte est maintenant activé.';
L10n::$locales['You can now sign in to: %s'] = 'Vous pouvez vous connecter à l\'adresse: %s';
L10n::$locales['Confirmation of registration'] = 'Confirmation d\'inscription';
L10n::$locales['Thank you for your registration on blog "%s"!'] = 'Merci pour votre inscription sur le blog "%s" !';
L10n::$locales['Site:'] = 'Site :';
L10n::$locales['Your wonderful, mysterious, and unbreakable password, the one you have memorised and/or saved in your favourite password manager.'] = 'Votre mot de passe merveilleux, mystérieux et inviolable, celui que vous avez mémorisé et/ou enregistré dans votre gestionnaire de mots de passe préféré.';
...
L10n::$locales['*Blog:* [%s](%s)'] = '';
L10n::$locales['*User:* %s'] = '';
L10n::$locales['*Email:* %s'] = 'Email :';
...
L10n::$locales['Form and menu'] = '';
L10n::$locales['Only form'] = '';
L10n::$locales['Only menu'] = '';
